...
VERTEX_LLM_TYPE_GEMINI_FLASH = "VertexAI-Gemini-2.0-Flash"
VERTEX_LLM_TYPE_GEMINI_2_0_FLASH = "VertexAI-Gemini-2.0-Flash"
VERTEX_LLM_TYPE_GEMINI_2_0_FLASH_LIGHT = "VertexAI-Gemini-2.0-Flash-Lite"
