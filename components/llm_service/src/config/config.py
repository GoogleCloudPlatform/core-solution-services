...
from config.model_config import (ModelConfig, VENDOR_OPENAI,
                                ...
                                VERTEX_LLM_TYPE_GEMINI_2_0_FLASH_LITE)
...
DEFAULT_MULTIMODAL_LLM_TYPE = VERTEX_LLM_TYPE_GEMINI_2_0_FLASH
DEFAULT_QUERY_CHAT_MODEL = VERTEX_LLM_TYPE_GEMINI_2_0_FLASH
...
DEFAULT_CHAT_SUMMARY_MODEL = VERTEX_LLM_TYPE_GEMINI_2_0_FLASH
