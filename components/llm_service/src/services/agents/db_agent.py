...
async def run_db_agent(prompt: str, llm_type: str = None, dataset = None,
  ...
  # process result for API output
  response_output = process_db_result(output, dataset, db_result_limit)
...
def process_db_result(db_result: dict, dataset_name: str,
  ...
  Args:
    db_result: result generated by agent
    dataset_name: name of dataset
    db_result_limit:  limit on number of rows to return
  Return:
