...
# embedding models
VERTEX_EMBEDDING_TYPES = [VERTEX_LLM_TYPE_GECKO_EMBEDDING]
LANGCHAIN_EMBEDDING_TYPES = []
if ENABLE_OPENAI_LLM:
  LANGCHAIN_EMBEDDING_TYPES.append(OPENAI_EMBEDDING_TYPE)
  LANGCHAIN_LLM.update({
    OPENAI_EMBEDDING_TYPE: OpenAIEmbeddings(openai_api_key=OPENAI_API_KEY)
  })

if ENABLE_LLAMA2CPP_LLM:
  LANGCHAIN_EMBEDDING_TYPES.append(LLAMA2CPP_LLM_TYPE_EMBEDDING)
  LANGCHAIN_LLM.update({
    LLAMA2CPP_LLM_TYPE_EMBEDDING: LlamaCppEmbeddings(model_path=LLAMA2CPP_MODEL_PATH)
  })


EMBEDDING_TYPES = VERTEX_EMBEDDING_TYPES + LANGCHAIN_EMBEDDING_TYPES
DEFAULT_QUERY_EMBEDDING_MODEL = VERTEX_LLM_TYPE_GECKO_EMBEDDING
Logger.info(f"Embedding models loaded {EMBEDDING_TYPES}")
