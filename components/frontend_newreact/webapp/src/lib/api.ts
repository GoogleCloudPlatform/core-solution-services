...
(token: string, chatId: string, userInput: string, llmType: string, stream = true, toolNames?: string[], temperature?: number, queryEngineId?: string, queryFilter?: Record<string, any>, uploadFile?: File, fileUrl?: string): Promise<Chat | ReadableStream<any> | null | undefined> => {
